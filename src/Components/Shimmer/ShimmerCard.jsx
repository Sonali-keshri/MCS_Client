...
const ShimmerCard = () => {
    return (
        <div className='shadow-xl p-6 rounded-xl relative mb-8 bg-gray-200 h-60 z-20 '>
            ...
            <div className='text-center py-2 '>
                <h1 className='w-4/5 h-8 bg-gray-100'></h1>
            </div>
            <div className='flex gap-8 rounded-xl py-2 '>
                <h1 className='w-3/5 h-8 bg-gray-100'></h1>
            </div>
            <div className='flex gap-8 rounded-xl py-2 '>
                <h1 className='w-2/5 h-8 bg-gray-100'></h1>
            </div>
        </div>
